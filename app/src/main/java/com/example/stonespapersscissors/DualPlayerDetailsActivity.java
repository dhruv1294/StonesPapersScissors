        ...
        playDualGameButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(player1Name.getText().toString().equals("")){
                    Toast.makeText(DualPlayerDetailsActivity.this, "Enter player 1 name", Toast.LENGTH_SHORT).show();
                }else if(player2Name.getText().toString().equals("")){
                    Toast.makeText(DualPlayerDetailsActivity.this, "Enter player 2 name", Toast.LENGTH_SHORT).show();
                }else if(noOfRounds.getText().toString().equals("")){
                    Toast.makeText(DualPlayerDetailsActivity.this, "Enter no. of rounds", Toast.LENGTH_SHORT).show();
                }else if(Integer.parseInt(noOfRounds.getText().toString())>10){
                    Toast.makeText(DualPlayerDetailsActivity.this, "Enter rounds less than equal to 10 ", Toast.LENGTH_SHORT).show();
                }else {
